    ...
    parameters = [
        {
            ...
            "approx_sync":True,
            #"Vis/CorType": "0",
            "Vis/MinInliers": "12",         # <<< Aumentar umbral de calidad
        ...
        # --- EL TRUCO PARA ROBUSTEZ 2D ---
            ...
            "pub_loc_pose_only_when_localizing": True,
            "Grid/FromDepth": "false",
            "Grid/3D": "false",
            #"subscribe_pose": True,
            #"use_pose": True,
            #"initial_pose": "0.1 0.2 0.0 0.0 0.0 0.03",
        ...
        LoadComposableNodes(
            ...
            composable_node_descriptions=[
                ComposableNode(
                    ...
                    name="rtabmap",
                    parameters=parameters,
                    remappings=slam_remappings+remappings,
                ),
            ],
        ),
    ]

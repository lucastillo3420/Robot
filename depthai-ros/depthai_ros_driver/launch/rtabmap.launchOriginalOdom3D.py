...
def launch_setup(context, *args, **kwargs):
    ...
    parameters = [
        ...
        # --- EL TRUCO PARA ROBUSTEZ 2D ---
            ...
            #"Grid/FromDepth": "true",
            #"Grid/3D": "false",
             "Grid/MaxObstacleHeight": "0.9",   # Ignora puntos por encima de 1.5 metros (ej. el techo)
            "Grid/NoiseFilteringRadius": "0.1", # Ayuda a eliminar puntos aislados
            "Grid/NoiseFilteringMinNeighbors": "5",
            "Grid/RangeMax": "4.0",
            "Grid/RangeMin": "0.3",
             "Grid/RayTracing": "true",
             "Grid/MaxGroundHeight": "0.10"  # Ignora puntos por debajo de 10 cm del suelo del robot
        } 

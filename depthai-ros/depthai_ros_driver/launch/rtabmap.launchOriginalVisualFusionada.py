...
def launch_setup(context, *args, **kwargs):
    ...
    visual_odometry_parameters = [
        {
            ...
            "Odom/Strategy": "0",
            "Vis/CorType": "1",
            "Vis/MinInliers": "20",         # <<< Aumentar umbral de calidad
            "Odom/ResetCountdown": "1", 
            "Odom/GuessMotion": "true",
            "Vis/ImageDecimation": "2",
    ...
    odom_remappings= base_remappings + [("odom", "/odom/visual")]
    return [
        Node(
        ...
        LoadComposableNodes(
            ...
            composable_node_descriptions=[
                ComposableNode(
                    ...
                    name="rgbd_odometry",
                    parameters=visual_odometry_parameters,
